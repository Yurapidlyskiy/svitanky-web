...
const CATEGORY_SEEDS: Record<NewsCategory, CategorySeed> = {
  news: {
    ...
    titles: [
      'Нова ініціатива: освітній проєкт для дітей',
      'Волонтери зустріли перші родини зі Сходу',
      'Як минув тиждень підтримки в громаді',
      'Ми відкрили новий простір для підлітків',
      'Історія родини, яка знайшла дім',
      'Партнери долучилися до закупівлі книг',
      'Підсумки весняного сезону служіння',
    ],
  },
  announcements: {
    excerpt: 'Через спільні роздуми, молитву та навчання допомагаємо дітям',
